    ...
    },
    {
      ...
      bodyCopy: (
        <div className="flex flex-col items-end gap-1 mt-12 mb-16">
          {/* Rhythmic Stacking */}
          <span className="text-secondary-display text-[#344128] text-right">A technologist.</span>
          <span className="font-serif italic text-4xl text-[#344128] mb-8 text-right">An artist.</span>
