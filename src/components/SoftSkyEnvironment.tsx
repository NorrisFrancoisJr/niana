        ...
        <div className="absolute inset-0 pointer-events-none z-[60] overflow-hidden" style={{ opacity: fadeOutOpacity }}>
          ...
          */}
          ...
          <img 
            ...
            alt="" 
            className="absolute top-[20%] left-[-20%] w-[70vw] max-w-[1100px] object-contain blur-[24px] brightness-110"
          />
          ...
          <img 
            ...
            alt="" 
            className="absolute top-[45%] left-[-15%] w-[40vw] max-w-[700px] object-contain blur-[16px] brightness-110"
          />
